      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-7xl">
          <div className="fade-in-up mb-12">
            <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-white mb-3 drop-shadow">Admin Dashboard</h1>
                ...
                <Card className="border-0 bg-white/[0.04] backdrop-blur-xl ring-1 ring-white/10 hover:ring-white/20 transition-all shadow-xl shadow-black/20">
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between mb-5">
                      <div className={`w-14 h-14 ${iconGradients[index % iconGradients.length]} rounded-xl flex items-center justify-center shadow-lg shadow-black/20`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            <div className="fade-in-up" style={{ animationDelay: "0.5s" }}>
              <Card className="h-full border-0 bg-white/[0.04] backdrop-blur-xl ring-1 ring-white/10 hover:ring-white/20 transition-all shadow-xl shadow-black/20">
                ...
                <CardContent className="flex-1 flex flex-col">
                  <p className="text-cyan-100/80 mb-6 flex-1">Add, edit, and manage your premium vehicle fleet with advanced controls</p>
            ...
            <div className="fade-in-up" style={{ animationDelay: "0.6s" }}>
              <Card className="h-full border-0 bg-white/[0.04] backdrop-blur-xl ring-1 ring-white/10 hover:ring-white/20 transition-all shadow-xl shadow-black/20">
                ...
                <CardContent className="flex-1 flex flex-col">
                  <p className="text-cyan-100/80 mb-6 flex-1">View and manage customer bookings with advanced filtering and status updates</p>
            ...
            <div className="fade-in-up" style={{ animationDelay: "0.7s" }}>
              <Card className="h-full border-0 bg-white/[0.04] backdrop-blur-xl ring-1 ring-white/10 hover:ring-white/20 transition-all shadow-xl shadow-black/20">
                ...
                <CardContent className="flex-1 flex flex-col">
                  <p className="text-cyan-100/80 mb-6 flex-1">Manage vehicle categories, locations, and system configurations</p>
                  <Button asChild variant="outline" className="btn-3d bg-white/5 hover:bg-white/10 border-white/10 text-white font-bold backdrop-blur">
          ...
          <div className="fade-in-up" style={{ animationDelay: "0.8s" }}>
            <Card className="border-0 bg-white/[0.04] backdrop-blur-xl ring-1 ring-white/10 shadow-xl shadow-black/20">
              ...
              <CardContent>
                {/* Keep your placeholder items here */}
                {/* ... */}
              </CardContent>
            </Card>
          </div>
